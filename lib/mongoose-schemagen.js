...
exports.generateMethods = function(schema, prototype, options){
	...
	if( options && options.static )
		for ( let key of Object.keys( options.static ) ){
			var value = options.static[key];
			if( _.isFunction( value ) || (value === Function) ){
...
exports.generate = function(mongoose, object, validation, schemaoptions, modelOptions){
	var schema = exports.generateMethods( exports.generateSchema(mongoose, object, schemaoptions), object, schemaoptions);
